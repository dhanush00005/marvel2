...
class Config:
    ...
    BOT_TOKEN = getenv("BOT_TOKEN", "7551511745:AAEEkKaoScAjYLbWspHKiMqGAxzo8vjqVyI")
    ...
    MONGO_URI = getenv("MONGO_URI", "mongodb+srv://dhanush143:<dhanush143@cluster0.5leil.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
